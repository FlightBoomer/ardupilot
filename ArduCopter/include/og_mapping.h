...
public:
    ...
    /** Map Size (mm) */
    const static int mapWidth = 45000; // 35000 for data1, 30000 for data2, 45000 for data3, 15000 for data4, 30000 for data5
    const static int mapHeight = 25000; // 25000 for data1, 30000 for data2, 25000 for data3, 50000 for data4, 15000 for data5
